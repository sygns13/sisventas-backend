...
import com.bcs.ventas.service.jasper.CajaIngresoOtrosJasperService;
...
@Service
public class CajaIngresoOtrosReportServiceImpl implements CajaIngresoOtrosReportService {
    ...
    @Autowired
    private CajaIngresoOtrosJasperService cajaIngresoOtrosJasperService;
    ...
    public byte[] exportPdf(FiltroGeneral filtros) throws Exception {
        ...
        List<CajaIngresoOtrosReport> cajaIngresoOtrosReport = new ArrayList<>();
        ...
        ingresoSalidaCajas.forEach((ingreso) -> {
            ...
            CajaIngresoOtrosReport CajaIngresoOtrosReportoBJ = new CajaIngresoOtrosReport();

            CajaIngresoOtrosReportoBJ.setNro(nro.get());
            CajaIngresoOtrosReportoBJ.setSucursal(ingreso.getAlmacen().getNombre());
            CajaIngresoOtrosReportoBJ.setConcepto(ingreso.getConcepto());
            CajaIngresoOtrosReportoBJ.setFecha(ingreso.getFecha().format(formato));
            CajaIngresoOtrosReportoBJ.setHora(ingreso.getHora().toString());
            ...
            CajaIngresoOtrosReportoBJ.setTipoComprobante(tipoMovimientoComprobante);
            CajaIngresoOtrosReportoBJ.setComprobante(ingreso.getComprobante());

            CajaIngresoOtrosReportoBJ.setImportePagado(ingreso.getMonto());

            montoTotal.set(montoTotal.get().add(ingreso.getMonto()));

            cajaIngresoOtrosReport.add(CajaIngresoOtrosReportoBJ);
        ...
        return cajaIngresoOtrosJasperService.exportToPdf(cajaIngresoOtrosReport,"data","reportCajaIngresoOtros", parametros);
    }
    ...
    public byte[] exportXls(FiltroGeneral filtros) throws Exception {
        ...
        return cajaIngresoOtrosJasperService.exportToXls(cajaIngresoOtrosReport,"data","reportCajaIngresoOtros", "hoja1", parametros);
    }
}
