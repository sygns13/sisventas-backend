...
@Service
public class VentasGeneralJasperServiceImpl extends ReportGeneratorServiceImpl<VentasGeneralReport> implements VentasGeneralJasperService {

    public byte[] exportToPdf(List<VentasGeneralReport> list, String nameData, String nameReport, Map<String, String> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<VentasGeneralReport> list, String nameData, String nameReport, String sheet, Map<String, String> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<VentasGeneralReport> list, String nameData, String nameReport, Map<String, String> parametros) throws FileNotFoundException, JRException {
