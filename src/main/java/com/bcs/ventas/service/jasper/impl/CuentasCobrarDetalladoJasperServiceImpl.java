...
@Service
public class CuentasCobrarDetalladoJasperServiceImpl extends ReportGeneratorServiceImpl<CuentasCobrarDetalladoReport> implements CuentasCobrarDetalladoJasperService {

    public byte[] exportToPdf(List<CuentasCobrarDetalladoReport> list, String nameData, String nameReport, Map<String, String> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CuentasCobrarDetalladoReport> list, String nameData, String nameReport, String sheet, Map<String, String> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<CuentasCobrarDetalladoReport> list, String nameData, String nameReport, Map<String, String> parametros) throws FileNotFoundException, JRException {
