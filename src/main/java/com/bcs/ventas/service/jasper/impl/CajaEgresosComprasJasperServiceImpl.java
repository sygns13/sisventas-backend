...
public class CajaEgresosComprasJasperServiceImpl extends ReportGeneratorServiceImpl<CajaEgresosComprasReport> implements CajaEgresosComprasJasperService {
    ...
    public byte[] exportToPdf(List<CajaEgresosComprasReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CajaEgresosComprasReport> list, String nameData, String nameReport, String sheet, Map<String, Object> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<CajaEgresosComprasReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws FileNotFoundException, JRException {
