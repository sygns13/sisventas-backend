...
@Service
public class CuentasPagarGeneralJasperServiceImpl extends ReportGeneratorServiceImpl<CuentasPagarGeneralReport> implements CuentasPagarGeneralJasperService {

    public byte[] exportToPdf(List<CuentasPagarGeneralReport> list, String nameData, String nameReport, Map<String, String> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CuentasPagarGeneralReport> list, String nameData, String nameReport, String sheet, Map<String, String> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<CuentasPagarGeneralReport> list, String nameData, String nameReport, Map<String, String> parametros) throws FileNotFoundException, JRException {
