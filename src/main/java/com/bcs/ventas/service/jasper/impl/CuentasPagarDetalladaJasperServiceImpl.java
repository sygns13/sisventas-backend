...
@Service
public class CuentasPagarDetalladaJasperServiceImpl extends ReportGeneratorServiceImpl<CuentasPagarDetalladaReport> implements CuentasPagarDetalladaJasperService {

    public byte[] exportToPdf(List<CuentasPagarDetalladaReport> list, String nameData, String nameReport, Map<String, String> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CuentasPagarDetalladaReport> list, String nameData, String nameReport, String sheet, Map<String, String> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<CuentasPagarDetalladaReport> list, String nameData, String nameReport, Map<String, String> parametros) throws FileNotFoundException, JRException {
