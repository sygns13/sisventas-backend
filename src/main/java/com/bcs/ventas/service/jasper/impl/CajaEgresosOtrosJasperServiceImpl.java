...
public class CajaEgresosOtrosJasperServiceImpl extends ReportGeneratorServiceImpl<CajaEgresosOtrosReport> implements CajaEgresosOtrosJasperService {
    ...
    public byte[] exportToPdf(List<CajaEgresosOtrosReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws JRException, IOException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CajaEgresosOtrosReport> list, String nameData, String nameReport, String sheet, Map<String, Object> parametros) throws JRException, IOException {
    ...
    private JasperPrint getReport(List<CajaEgresosOtrosReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws IOException, JRException {
