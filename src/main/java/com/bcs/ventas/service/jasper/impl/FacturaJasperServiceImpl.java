...
@Service
public class FacturaJasperServiceImpl implements FacturaJasperService {
    @Override
    public byte[] exportToPdf(List<FacturaDetailReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    private JasperPrint getReport(List<FacturaDetailReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws FileNotFoundException, JRException {
