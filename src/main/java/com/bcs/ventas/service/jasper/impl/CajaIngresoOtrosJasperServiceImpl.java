...
@Service
public class CajaIngresoOtrosJasperServiceImpl extends ReportGeneratorServiceImpl<CajaIngresoOtrosReport> implements CajaIngresoOtrosJasperService {

    public byte[] exportToPdf(List<CajaIngresoOtrosReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<CajaIngresoOtrosReport> list, String nameData, String nameReport, String sheet, Map<String, Object> parametros) throws JRException, FileNotFoundException {
    ...
    private JasperPrint getReport(List<CajaIngresoOtrosReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws FileNotFoundException, JRException {
