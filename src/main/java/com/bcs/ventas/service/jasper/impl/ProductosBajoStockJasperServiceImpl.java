...
public class ProductosBajoStockJasperServiceImpl extends ReportGeneratorServiceImpl<ProductosBajoStockReport> implements ProductosBajoStockJasperService {
    ...
    public byte[] exportToPdf(List<ProductosBajoStockReport> list, String nameData, String nameReport, Map<String, String> parametros) throws JRException, IOException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    public byte[] exportToXls(List<ProductosBajoStockReport> list, String nameData, String nameReport, String sheet, Map<String, String> parametros) throws JRException, IOException {
    ...
    private JasperPrint getReport(List<ProductosBajoStockReport> list, String nameData, String nameReport, Map<String, String> parametros) throws IOException, JRException {
