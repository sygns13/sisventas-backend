...
@Service
public class BoletaJasperServiceImpl implements BoletaJasperService {
    @Override
    public byte[] exportToPdf(List<BoletaDetailReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws JRException, FileNotFoundException {
        return JasperExportManager.exportReportToPdf(getReport(list, nameData, nameReport, parametros));
    }

    private JasperPrint getReport(List<BoletaDetailReport> list, String nameData, String nameReport, Map<String, Object> parametros) throws FileNotFoundException, JRException {
