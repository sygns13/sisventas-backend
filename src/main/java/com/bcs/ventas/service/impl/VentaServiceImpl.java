...
public class VentaServiceImpl implements VentaService {
    ...
    @Override
    public Page<CobroVenta> listarCobradoDetalle(Pageable page, FiltroVenta filtros) throws Exception {
        ...
        Long total = ventaMapper.getTotalElementsCobrarVenta(params);
        Long totalPages = (long) Math.ceil( ((double)total) / page.getPageSize());
        Long offset = (long) page.getPageSize() *(page.getPageNumber());
        ...
        List<CobroVenta> cobrarVentas = ventaMapper.listByParameterMapCobrarVenta(params);

        cobrarVentas.forEach((dto) -> {
        ...
        return new PageImpl<>(cobrarVentas, page, total);
    }
