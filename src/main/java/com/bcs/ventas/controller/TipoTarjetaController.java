...
public class TipoTarjetaController {
    ...
    @GetMapping
    public ResponseEntity<Page<TipoTarjeta>> listar(@RequestHeader(HttpHeaders.AUTHORIZATION) String Authorization,
    ...
    public ResponseEntity<List<TipoTarjeta>> listarAll(@RequestHeader(HttpHeaders.AUTHORIZATION) String Authorization) throws Exception{
    ...
    @GetMapping("/{id}")
    public ResponseEntity<TipoTarjeta> listarPorId(@RequestHeader(HttpHeaders.AUTHORIZATION) String Authorization,
    ...
    @PostMapping
    public ResponseEntity<TipoTarjeta> registrar(@RequestHeader(HttpHeaders.AUTHORIZATION) String Authorization,
                                                 @Valid @RequestBody TipoTarjeta a) throws Exception{
